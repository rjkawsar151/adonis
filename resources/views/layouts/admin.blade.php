    ...
    <aside class="hidden lg:flex flex-col fixed inset-y-0 left-0 w-64 bg-[#111827] text-gray-300 z-30 border-r border-gray-800">
        ...
        <div class="flex flex-col flex-1 min-h-0">
            <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-1.5 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
                ...
                @if(str_contains($currentRoute, 'blogs') || str_contains($currentRoute, 'blog-categories') || str_contains($currentRoute, 'blog-tags') || str_contains($currentRoute, 'blog-authors'))
                <div class="pl-4 space-y-1">
                    <a href="{{ route('admin.blog-categories.index') }}" class="flex items-center space-x-2 py-1.5 px-4 rounded-xl text-xs font-semibold {{ str_contains($currentRoute, 'blog-categories') ? 'text-[#C9A84C]' : 'text-gray-400 hover:text-white' }}">
                        <span>• Categories</span>
                    </a>
                    <a href="{{ route('admin.blog-tags.index') }}" class="flex items-center space-x-2 py-1.5 px-4 rounded-xl text-xs font-semibold {{ str_contains($currentRoute, 'blog-tags') ? 'text-[#C9A84C]' : 'text-gray-400 hover:text-white' }}">
                        <span>• Tags</span>
                    </a>
                    <a href="{{ route('admin.blog-authors.index') }}" class="flex items-center space-x-2 py-1.5 px-4 rounded-xl text-xs font-semibold {{ str_contains($currentRoute, 'blog-authors') ? 'text-[#C9A84C]' : 'text-gray-400 hover:text-white' }}">
                        <span>• Authors</span>
                    </a>
                </div>
                @endif
                ...
                <a href="{{ url('/admin/about-page') }}" class="flex items-center space-x-3 py-2.5 px-4 rounded-xl text-sm font-semibold transition-all duration-200 {{ str_contains($currentRoute, 'about-page') ? 'bg-[#C9A84C] text-black shadow-md' : 'hover:bg-gray-800 hover:text-white' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="border-t border-gray-800 my-2 pt-2">
                    ...
                    <a href="{{ url('/admin/careers') }}" class="flex items-center space-x-3 py-2.5 px-4 rounded-xl text-sm font-semibold transition-all duration-200 {{ str_contains($currentRoute, 'admin/careers') && !str_contains($currentRoute, 'applications') ? 'bg-[#C9A84C] text-black shadow-md' : 'hover:bg-gray-800 hover:text-white' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ url('/admin/careers/applications') }}" class="flex items-center space-x-3 py-2.5 px-4 rounded-xl text-sm font-semibold transition-all duration-200 {{ str_contains($currentRoute, 'admin/careers/applications') ? 'bg-[#C9A84C] text-black shadow-md' : 'hover:bg-gray-800 hover:text-white' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ url('/admin/departments') }}" class="flex items-center space-x-3 py-2.5 px-4 rounded-xl text-sm font-semibold transition-all duration-200 {{ str_contains($currentRoute, 'admin/departments') ? 'bg-[#C9A84C] text-black shadow-md' : 'hover:bg-gray-800 hover:text-white' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="{{ url('/admin/employment-types') }}" class="flex items-center space-x-3 py-2.5 px-4 rounded-xl text-sm font-semibold transition-all duration-200 {{ str_contains($currentRoute, 'admin/employment-types') ? 'bg-[#C9A84C] text-black shadow-md' : 'hover:bg-gray-800 hover:text-white' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div id="admin-drawer-content" class="fixed inset-y-0 left-0 w-72 max-w-[85vw] bg-[#111827] text-gray-300 flex flex-col transform -translate-x-full transition-transform duration-300 ease-in-out">
            ...
            <nav class="flex-1 overflow-y-auto px-4 py-6 space-y-1.5">
                ...
                <div class="border-t border-gray-800 my-2 pt-2">
                    ...
                    <a href="{{ url('/admin/careers/applications') }}" class="flex items-center space-x-3 py-2 px-4 rounded-xl text-xs font-semibold hover:bg-gray-800 hover:text-white">Applications</a>
