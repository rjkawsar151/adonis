...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-[#111827] border border-gray-800 p-6">
        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            @endif
            @if(Auth::user()->hasModuleAccess('memberships'))
            <a href="{{ url('/admin/memberships') }}" class="p-4 border border-gray-800 hover:border-[#C9A84C]/30 bg-gray-900/50 hover:bg-gray-800 transition-colors text-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto mb-2 text-[#C9A84C]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
                <span class="text-xs font-bold text-gray-300">View Memberships</span>
            </a>
            @endif
            @if(Auth::user()->hasModuleAccess('price-list'))
